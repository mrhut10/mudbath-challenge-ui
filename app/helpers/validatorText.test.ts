...
export default () => {
  ...
  {
    const failMessage = 'should be required'
    const testResult = new ValidatorText()
  ...
  }
  {
    ...
    assert(
      test.evaluate('0.01')[0] === false &&
        test.evaluate('t')[0] === false &&
        test.evaluate('t')[1] === failMessage,
