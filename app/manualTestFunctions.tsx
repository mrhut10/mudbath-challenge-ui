  ...
  return (
    <div>
      <div className="m-3 gb-green-400 w-full">
        ...
        <div>hello {user}</div>
        <button className="m-2 p-2 bg-blue-400" onClick={toogleUser}>
          click to toogle user
        </button>
      </div>
      <div className="m-3">
      ...
      <div>
        ...
        <button onClick={() => setSelectedCurrency('Bo')}>
          Select Currency
        </button>
      </div>
      <div>
        ...
        <button
          ...
          onClick={() => Stack.addValue('hello' + Stack.allValues.length)}
        >
          Add Hello
        </button>
        <button
          className="p-2 m-2 bg-blue-300"
          onClick={() => Stack.removeValues()}
        >
          remove 1 value
        </button>
        <button
          className="p-2 m-2 bg-blue-300"
          onClick={() => Stack.removeValues(3)}
        >
          remove 3 value
        </button>
        <button
          className="p-2 m-2 bg-blue-300"
          onClick={() => Stack.dangerSetValues(['boo'])}
        >
          danerously set to ['boo']
        </button>
      </div>
      <div>
        ...
        <button
          className="p-2 m-2 bg-blue-300"
          onClick={() => popupState.openProductDetails(allProducts.data, 1)}
        >
          openDetails
        </button>
        <button
          className="p-2 m-2 bg-blue-300"
          onClick={() => popupState.openProductEdit(allProducts.data, 1, user)}
        >
          openEdit
        </button>
        <button
        ...
        <button
          className="p-2 m-2 bg-blue-300"
          onClick={() => popupState.closePopups(3)}
        >
          close 3 position
        </button>
        <button
          className="p-2 m-2 bg-blue-300"
          onClick={() =>
            popupState.danerousProductIDChangeAndCloseWindow(user, 1, 2)
          }
        >
          rename id:1 to id:10 (work)
        </button>
      </div>
    </div>
  )
