...
const ProductForm = ({
  ...
  const validationRules = {
    ...
    relatedProducts: new ValidatorObject()
      ...
      .genericTest('items must be integers', (input: any[]) =>
        input.every(
  ...
  const ValidationResults: NamedValidationResults[] = Object.keys(
    fieldData,
  ).map((key) => [key, validationRules[key].evaluate(fieldData[key])])
  const ValidationErrors: NamedValidationResults[] = ValidationResults.filter(
    (item) => item[1][0] !== true,
  )
    ...
    <form className="p-4 w-full">
      ...
      >
        <Input
          ...
          required
          validatorResult={
            ValidationResults.find((item) => item[0] === 'id')[1]
          }
          step="1"
      ...
      <TooltipValidation
        ...
        NotValidMessage={
          ValidationResults.find((item) => item[0] === 'name')[1][1]
        }
      ...
      >
        <Input
          ...
          required
          validatorResult={
            ValidationResults.find((item) => item[0] === 'name')[1]
          }
          step="1"
      ...
      <TooltipValidation
        ...
        NotValidMessage={
          ValidationResults.find((item) => item[0] === 'description')[1][1]
        }
      ...
      >
        <Input
          ...
          validatorResult={
            ValidationResults.find((item) => item[0] === 'description')[1]
          }
      ...
      >
        <Input
          ...
          required
          validatorResult={
            ValidationResults.find((item) => item[0] === 'priceBase')[1]
          }
        ...
        <Input
          ...
          required
          validatorResult={
            ValidationResults.find((item) => item[0] === 'priceAmount')[1]
          }
          step="0.01"
              ...
              return (
                ...
                >
                  <div className="w-1/2 text-red-400 w-32">
                    {fieldData.relatedProducts.includes(item.id)
                      ? 'SELECTED'
                      : ''}
                  </div>
                  <div className="w-1/2">
